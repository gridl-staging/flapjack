...
| AUD-013 | `/migrate` | Provider-neutral Algolia, Meilisearch, and Typesense controls, discovery, dry-run preview reports, preview-gated submit, async status, terminal-result contracts, Meilisearch refusal guidance, and 390px route usability are implemented and green. | `engine/dashboard/tests/e2e-ui/stage3_route_audit_390.spec.ts`; `engine/dashboard/tests/e2e-ui/full/migrate.spec.ts`; `engine/dashboard/tests/e2e-ui/full/migrate-algolia.spec.ts`; `engine/dashboard/tests/e2e-ui/full/migrate-meilisearch.spec.ts`; `engine/dashboard/tests/e2e-ui/full/migrate-typesense.spec.ts`; `engine/dashboard/tests/e2e-ui/migrate-meilisearch-refusal.spec.ts` | None |
