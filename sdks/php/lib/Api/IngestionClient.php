...
namespace Flapjack\FlapjackSearch\Api;

use Flapjack\FlapjackSearch\Flapjack;
use Flapjack\FlapjackSearch\Configuration\IngestionConfig;
use Flapjack\FlapjackSearch\Exceptions\ExceededRetriesException;
use Flapjack\FlapjackSearch\Exceptions\NotFoundException;
use Flapjack\FlapjackSearch\Model\Ingestion\Authentication;
use Flapjack\FlapjackSearch\Model\Ingestion\AuthenticationCreate;
use Flapjack\FlapjackSearch\Model\Ingestion\AuthenticationCreateResponse;
use Flapjack\FlapjackSearch\Model\Ingestion\AuthenticationSearch;
use Flapjack\FlapjackSearch\Model\Ingestion\AuthenticationUpdate;
use Flapjack\FlapjackSearch\Model\Ingestion\AuthenticationUpdateResponse;
use Flapjack\FlapjackSearch\Model\Ingestion\DeleteResponse;
use Flapjack\FlapjackSearch\Model\Ingestion\Destination;
use Flapjack\FlapjackSearch\Model\Ingestion\DestinationCreate;
use Flapjack\FlapjackSearch\Model\Ingestion\DestinationCreateResponse;
use Flapjack\FlapjackSearch\Model\Ingestion\DestinationSearch;
use Flapjack\FlapjackSearch\Model\Ingestion\DestinationUpdate;
use Flapjack\FlapjackSearch\Model\Ingestion\DestinationUpdateResponse;
use Flapjack\FlapjackSearch\Model\Ingestion\Event;
use Flapjack\FlapjackSearch\Model\Ingestion\ListAuthenticationsResponse;
use Flapjack\FlapjackSearch\Model\Ingestion\ListDestinationsResponse;
use Flapjack\FlapjackSearch\Model\Ingestion\ListEventsResponse;
use Flapjack\FlapjackSearch\Model\Ingestion\ListSourcesResponse;
use Flapjack\FlapjackSearch\Model\Ingestion\ListTasksResponse;
use Flapjack\FlapjackSearch\Model\Ingestion\ListTasksResponseV1;
use Flapjack\FlapjackSearch\Model\Ingestion\ListTransformationsResponse;
use Flapjack\FlapjackSearch\Model\Ingestion\PushTaskPayload;
use Flapjack\FlapjackSearch\Model\Ingestion\Run;
use Flapjack\FlapjackSearch\Model\Ingestion\RunListResponse;
use Flapjack\FlapjackSearch\Model\Ingestion\RunResponse;
use Flapjack\FlapjackSearch\Model\Ingestion\RunSourcePayload;
use Flapjack\FlapjackSearch\Model\Ingestion\RunSourceResponse;
use Flapjack\FlapjackSearch\Model\Ingestion\RunTaskPayload;
use Flapjack\FlapjackSearch\Model\Ingestion\Source;
use Flapjack\FlapjackSearch\Model\Ingestion\SourceCreate;
use Flapjack\FlapjackSearch\Model\Ingestion\SourceCreateResponse;
use Flapjack\FlapjackSearch\Model\Ingestion\SourceSearch;
use Flapjack\FlapjackSearch\Model\Ingestion\SourceUpdate;
use Flapjack\FlapjackSearch\Model\Ingestion\SourceUpdateResponse;
use Flapjack\FlapjackSearch\Model\Ingestion\Task;
use Flapjack\FlapjackSearch\Model\Ingestion\TaskCreate;
use Flapjack\FlapjackSearch\Model\Ingestion\TaskCreateResponse;
use Flapjack\FlapjackSearch\Model\Ingestion\TaskCreateV1;
use Flapjack\FlapjackSearch\Model\Ingestion\TaskReplace;
use Flapjack\FlapjackSearch\Model\Ingestion\TaskSearch;
use Flapjack\FlapjackSearch\Model\Ingestion\TaskUpdate;
use Flapjack\FlapjackSearch\Model\Ingestion\TaskUpdateResponse;
use Flapjack\FlapjackSearch\Model\Ingestion\TaskUpdateV1;
use Flapjack\FlapjackSearch\Model\Ingestion\TaskV1;
use Flapjack\FlapjackSearch\Model\Ingestion\Transformation;
use Flapjack\FlapjackSearch\Model\Ingestion\TransformationCreate;
use Flapjack\FlapjackSearch\Model\Ingestion\TransformationCreateResponse;
use Flapjack\FlapjackSearch\Model\Ingestion\TransformationSearch;
use Flapjack\FlapjackSearch\Model\Ingestion\TransformationTry;
use Flapjack\FlapjackSearch\Model\Ingestion\TransformationTryResponse;
use Flapjack\FlapjackSearch\Model\Ingestion\TransformationUpdateResponse;
use Flapjack\FlapjackSearch\Model\Ingestion\WatchResponse;
use Flapjack\FlapjackSearch\ObjectSerializer;
use Flapjack\FlapjackSearch\RetryStrategy\FlapjackResponse;
use Flapjack\FlapjackSearch\RetryStrategy\ApiWrapper;
use Flapjack\FlapjackSearch\RetryStrategy\ApiWrapperInterface;
...
class IngestionClient
{
    ...
    /**
     * Send requests to the Flapjack REST API (with HTTP info).
     *
     * Returns the response with HTTP metadata (status code, headers, body)
     * This method lets you send requests to the Flapjack REST API.
     *
    ...
    public function chunkedPush(
        ...
        foreach ($objects as $object) {
            ...
            if ($waitForTasks && !empty($responses) && (0 === sizeof($responses) % $waitBatchSize || $count === sizeof($objects))) {
                $timeoutCalculation = 'Flapjack\FlapjackSearch\Support\Helpers::linearTimeout';
