...
use Flapjack\FlapjackSearch\Configuration\PersonalizationConfig;
use Flapjack\FlapjackSearch\Model\Personalization\DeleteUserProfileResponse;
use Flapjack\FlapjackSearch\Model\Personalization\GetUserTokenResponse;
use Flapjack\FlapjackSearch\Model\Personalization\PersonalizationStrategyParams;
use Flapjack\FlapjackSearch\Model\Personalization\SetPersonalizationStrategyResponse;
    ...
    public static function getClusterHosts(PersonalizationConfig $config)
    {
        if ($hosts = $config->getHosts()) {
            ...
            $url = null !== $config->getRegion() && '' !== $config->getRegion()
                ? str_replace('{region}', $config->getRegion(), 'personalization.{region}.flapjack.io')
                : '';
