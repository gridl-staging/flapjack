...
Official Swift client for the [Flapjack Search API](https://github.com/gridl-staging).
...
Add to your `Package.swift` using repository URL <https://github.com/gridl-staging/flapjack-search-swift.git>:
