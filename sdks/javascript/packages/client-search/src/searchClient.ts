...
import type { BrowseParamsObject } from '../model/browseParamsObject';
...
import type { ReplaceAllObjectsWithTransformationResponse } from '../model/replaceAllObjectsWithTransformationResponse';
...
export function createSearchClient({
  ...
  return {
     ...
     * @param chunkedBatch.objects - The array of `objects` to store in the given Flapjack `indexName`.
     ...
     * @param saveObjects.objects - The array of `objects` to store in the given Flapjack `indexName`.
     ...
     * @param partialUpdateObjects.objects - The array of `objects` to update in the given Flapjack `indexName`.
     ...
     * @param replaceAllObjects.objects - The array of `objects` to store in the given Flapjack `indexName`.
    ...
    /**
     * Helper: calls the `search` method but with certainty that we will only request Flapjack records (hits) and not facets.
    ...
    /**
     * Helper: calls the `search` method but with certainty that we will only request Flapjack facets and not records (hits).
...
requestOptions?: RequestOptions ) : Promise<AddApiKeyResponse> {
    ...
    /**
      ...
      *  - addObject
          ...
          * @param addOrUpdateObject.body - The record. A schemaless object with attributes that are useful in the context of search and discovery.
                 * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
    */
    addOrUpdateObject<T extends object>(     { indexName, objectID, body,  }: AddOrUpdateObjectProps<T>,
requestOptions?: RequestOptions ) : Promise<UpdatedAtWithObjectIdResponse> {
...
requestOptions?: RequestOptions ) : Promise<CreatedAtResponse> {
    ...
    /**
      ...
      * @deprecated
          ...
          * @param assignUserId.assignUserIdParams - The assignUserIdParams object.
                 * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
    */
    assignUserId(     { xAlgoliaUserID, assignUserIdParams,  }: AssignUserIdProps,
requestOptions?: RequestOptions ) : Promise<CreatedAtResponse> {
    ...
    /**
      ...
      *  - addObject
          ...
          * @param batch.batchWriteParams - The batchWriteParams object.
                 * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
    */
    batch(     { indexName, batchWriteParams,  }: BatchProps,
requestOptions?: RequestOptions ) : Promise<BatchResponse> {
    ...
    /**
      ...
      * @deprecated
          ...
          * @param batchAssignUserIds.batchAssignUserIdsParams - The batchAssignUserIdsParams object.
                 * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
    */
    batchAssignUserIds(     { xAlgoliaUserID, batchAssignUserIdsParams,  }: BatchAssignUserIdsProps,
requestOptions?: RequestOptions ) : Promise<CreatedAtResponse> {
    ...
    /**
      ...
      *  - editSettings
          ...
          * @param batchDictionaryEntries.batchDictionaryEntriesParams - The batchDictionaryEntriesParams object.
                 * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
    */
    batchDictionaryEntries(     { dictionaryName, batchDictionaryEntriesParams,  }: BatchDictionaryEntriesProps,
requestOptions?: RequestOptions ) : Promise<UpdatedAtResponse> {
    ...
    /**
      ...
      *  - browse
          ...
          * @param browse.browseParams - The browseParams object.
                 * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
    */
    browse<T>(     { indexName, browseParams,  }: BrowseProps,
requestOptions?: RequestOptions ) : Promise<BrowseResponse<T>> {
    ...
    /**
      ...
      *  - deleteIndex
          ...
          * @param clearObjects.indexName - Name of the index on which to perform the operation.
                 * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
    */
    clearObjects(     { indexName,  }: ClearObjectsProps,
requestOptions?: RequestOptions ) : Promise<UpdatedAtResponse> {
    ...
    /**
      ...
      *  - editSettings
          ...
          * @param clearRules.forwardToReplicas - Whether changes are applied to replica indices.
                 * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
    */
    clearRules(     { indexName, forwardToReplicas,  }: ClearRulesProps,
requestOptions?: RequestOptions ) : Promise<UpdatedAtResponse> {
    ...
    /**
      ...
      *  - editSettings
          ...
          * @param clearSynonyms.forwardToReplicas - Whether changes are applied to replica indices.
                 * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
    */
    clearSynonyms(     { indexName, forwardToReplicas,  }: ClearSynonymsProps,
requestOptions?: RequestOptions ) : Promise<UpdatedAtResponse> {
    ...
    /**
      * This method lets you send requests to the Algolia REST API.
          ...
          * @param customDelete.parameters - Query parameters to apply to the current query.
                 * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
    */
    customDelete(     { path, parameters,  }: CustomDeleteProps,
requestOptions?: RequestOptions ) : Promise<Record<string, unknown>> {
    ...
    /**
      * This method lets you send requests to the Algolia REST API.
          ...
          * @param customGet.parameters - Query parameters to apply to the current query.
                 * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
    */
    customGet(     { path, parameters,  }: CustomGetProps,
requestOptions?: RequestOptions ) : Promise<Record<string, unknown>> {
    ...
    /**
      * This method lets you send requests to the Algolia REST API.
          ...
          * @param customPost.body - Parameters to send with the custom request.
                 * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
    */
    customPost(     { path, parameters, body,  }: CustomPostProps,
requestOptions?: RequestOptions ) : Promise<Record<string, unknown>> {
    ...
    /**
      ...
      *  - admin
          ...
          * @param deleteApiKey.key - API key.
                 * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
    */
    deleteApiKey(     { key,  }: DeleteApiKeyProps,
requestOptions?: RequestOptions ) : Promise<DeleteApiKeyResponse> {
    ...
    /**
      ...
      *  - deleteIndex
          ...
          * @param deleteBy.deleteByParams - The deleteByParams object.
                 * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
    */
    deleteBy(     { indexName, deleteByParams,  }: DeleteByProps,
requestOptions?: RequestOptions ) : Promise<UpdatedAtResponse> {
    ...
    /**
      ...
      *  - deleteIndex
          ...
          * @param deleteIndex.indexName - Name of the index on which to perform the operation.
                 * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
    */
    deleteIndex(     { indexName,  }: DeleteIndexProps,
requestOptions?: RequestOptions ) : Promise<DeletedAtResponse> {
    ...
    /**
      ...
      *  - deleteObject
          ...
          * @param deleteObject.objectID - Unique record identifier.
                 * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
    */
    deleteObject(     { indexName, objectID,  }: DeleteObjectProps,
requestOptions?: RequestOptions ) : Promise<DeletedAtResponse> {
    ...
    /**
      ...
      *  - editSettings
          ...
          * @param deleteRule.forwardToReplicas - Whether changes are applied to replica indices.
                 * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
    */
    deleteRule(     { indexName, objectID, forwardToReplicas,  }: DeleteRuleProps,
requestOptions?: RequestOptions ) : Promise<UpdatedAtResponse> {
    ...
    /**
      ...
      *  - admin
          ...
          * @param deleteSource.source - IP address range of the source.
                 * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
    */
    deleteSource(     { source,  }: DeleteSourceProps,
requestOptions?: RequestOptions ) : Promise<DeleteSourceResponse> {
    ...
    /**
      ...
      *  - editSettings
          ...
          * @param deleteSynonym.forwardToReplicas - Whether changes are applied to replica indices.
                 * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
    */
    deleteSynonym(     { indexName, objectID, forwardToReplicas,  }: DeleteSynonymProps,
requestOptions?: RequestOptions ) : Promise<DeletedAtResponse> {
    ...
    /**
      ...
      *  - search
          ...
          * @param getApiKey.key - API key.
                 * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
    */
    getApiKey(     { key,  }: GetApiKeyProps,
requestOptions?: RequestOptions ) : Promise<GetApiKeyResponse> {
    ...
    /**
      ...
      *  - editSettings
          ...
          * @param getAppTask.taskID - Unique task identifier.
                 * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
    */
    getAppTask(     { taskID,  }: GetAppTaskProps,
requestOptions?: RequestOptions ) : Promise<GetTaskResponse> {
...
requestOptions: RequestOptions | undefined = undefined ) : Promise<GetLogsResponse> {
    ...
    /**
      ...
      *  - search
          ...
          * @param getObject.attributesToRetrieve - Attributes to include with the records in the response. This is useful to reduce the size of the API response. By default, all retrievable attributes are returned.  `objectID` is always retrieved.  Attributes included in `unretrievableAttributes` won\'t be retrieved unless the request is authenticated with the admin API key. 
                 * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
    */
    getObject(     { indexName, objectID, attributesToRetrieve,  }: GetObjectProps,
requestOptions?: RequestOptions ) : Promise<Record<string, unknown>> {
    ...
    /**
      ...
      *  - search
             ...
             * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
    */
    getObjects<T>(       getObjectsParams: GetObjectsParams  ,
requestOptions?: RequestOptions ) : Promise<GetObjectsResponse<T>> {
    ...
    /**
      ...
      *  - settings
          ...
          * @param getRule.objectID - Unique identifier of a rule object.
                 * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
    */
    getRule(     { indexName, objectID,  }: GetRuleProps,
requestOptions?: RequestOptions ) : Promise<Rule> {
    ...
    /**
      ...
      *  - settings
          ...
          * @param getSettings.getVersion - When set to 2, the endpoint will not include `synonyms` in the response. This parameter is here for backward compatibility.
                 * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
    */
    getSettings(     { indexName, getVersion,  }: GetSettingsProps,
requestOptions?: RequestOptions ) : Promise<SettingsResponse> {
    ...
    /**
      ...
      *  - settings
          ...
          * @param getSynonym.objectID - Unique identifier of a synonym object.
                 * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
    */
    getSynonym(     { indexName, objectID,  }: GetSynonymProps,
requestOptions?: RequestOptions ) : Promise<SynonymHit> {
    ...
    /**
      ...
      *  - addObject
          ...
          * @param getTask.taskID - Unique task identifier.
                 * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
    */
    getTask(     { indexName, taskID,  }: GetTaskProps,
requestOptions?: RequestOptions ) : Promise<GetTaskResponse> {
...
requestOptions?: RequestOptions ) : Promise<UserId> {
    ...
    /**
      ...
      * @deprecated
          ...
          * @param hasPendingMappings.getClusters - Whether to include the cluster\'s pending mapping state in the response.
                 * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
    */
    hasPendingMappings(     { getClusters,  }: HasPendingMappingsProps = {},
requestOptions: RequestOptions | undefined = undefined ) : Promise<HasPendingMappingsResponse> {
    ...
    /**
      ...
      *  - listIndexes
          ...
          * @param listIndices.hitsPerPage - Number of hits per page.
                 * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
    */
    listIndices(     { page, hitsPerPage,  }: ListIndicesProps = {},
requestOptions: RequestOptions | undefined = undefined ) : Promise<ListIndicesResponse> {
    ...
    /**
      ...
      * @deprecated
          ...
          * @param listUserIds.hitsPerPage - Number of hits per page.
                 * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
    */
    listUserIds(     { page, hitsPerPage,  }: ListUserIdsProps = {},
requestOptions: RequestOptions | undefined = undefined ) : Promise<ListUserIdsResponse> {
    ...
    /**
      ...
      *  - addObject
             ...
             * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
    */
    multipleBatch(       batchParams: BatchParams  ,
requestOptions?: RequestOptions ) : Promise<MultipleBatchResponse> {
    ...
    /**
      ...
      *  - addObject
          ...
          * @param operationIndex.operationIndexParams - The operationIndexParams object.
                 * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
    */
    operationIndex(     { indexName, operationIndexParams,  }: OperationIndexProps,
requestOptions?: RequestOptions ) : Promise<UpdatedAtResponse> {
    ...
    /**
      ...
      *  - addObject
          ...
          * @param partialUpdateObject.createIfNotExists - Whether to create a new record if it doesn\'t exist.
                 * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
    */
    partialUpdateObject(     { indexName, objectID, attributesToUpdate, createIfNotExists,  }: PartialUpdateObjectProps,
requestOptions?: RequestOptions ) : Promise<UpdatedAtWithObjectIdResponse> {
    ...
    /**
      ...
      * @deprecated
          ...
          * @param removeUserId.userID - Unique identifier of the user who makes the search request.
                 * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
    */
    removeUserId(     { userID,  }: RemoveUserIdProps,
requestOptions?: RequestOptions ) : Promise<RemoveUserIdResponse> {
    ...
    /**
      ...
      *  - admin
          ...
          * @param replaceSources.source - Allowed sources.
                 * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
    */
    replaceSources(     { source,  }: ReplaceSourcesProps,
requestOptions?: RequestOptions ) : Promise<ReplaceSourceResponse> {
    ...
    /**
      ...
      *  - admin
          ...
          * @param restoreApiKey.key - API key.
                 * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
    */
    restoreApiKey(     { key,  }: RestoreApiKeyProps,
requestOptions?: RequestOptions ) : Promise<AddApiKeyResponse> {
    ...
    /**
      ...
      *  - addObject
          ...
          * @param saveObject.body - The record. A schemaless object with attributes that are useful in the context of search and discovery.
                 * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
    */
    saveObject<T extends object>(     { indexName, body,  }: SaveObjectProps<T>,
requestOptions?: RequestOptions ) : Promise<SaveObjectResponse> {
    ...
    /**
      ...
      *  - editSettings
          ...
          * @param saveRule.forwardToReplicas - Whether changes are applied to replica indices.
                 * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
    */
    saveRule(     { indexName, objectID, rule, forwardToReplicas,  }: SaveRuleProps,
requestOptions?: RequestOptions ) : Promise<UpdatedAtResponse> {
    ...
    /**
      ...
      *  - editSettings
          ...
          * @param saveRules.clearExistingRules - Whether existing rules should be deleted before adding this batch.
                 * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
    */
    saveRules(     { indexName, rules, forwardToReplicas, clearExistingRules,  }: SaveRulesProps,
requestOptions?: RequestOptions ) : Promise<UpdatedAtResponse> {
    ...
    /**
      ...
      *  - editSettings
          ...
          * @param saveSynonym.forwardToReplicas - Whether changes are applied to replica indices.
                 * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
    */
    saveSynonym(     { indexName, objectID, synonymHit, forwardToReplicas,  }: SaveSynonymProps,
requestOptions?: RequestOptions ) : Promise<SaveSynonymResponse> {
...
requestOptions?: RequestOptions ) : Promise<UpdatedAtResponse> {
    ...
    /**
      ...
      *  - search
             ...
             * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
    */
    search<T>(       searchMethodParams: SearchMethodParams  | LegacySearchMethodProps ,
requestOptions?: RequestOptions ) : Promise<SearchResponses<T>> {
    ...
    /**
      ...
      *  - settings
          ...
          * @param searchDictionaryEntries.searchDictionaryEntriesParams - The searchDictionaryEntriesParams object.
                 * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
    */
    searchDictionaryEntries(     { dictionaryName, searchDictionaryEntriesParams,  }: SearchDictionaryEntriesProps,
requestOptions?: RequestOptions ) : Promise<SearchDictionaryEntriesResponse> {
...
requestOptions?: RequestOptions ) : Promise<SearchForFacetValuesResponse> {
    ...
    /**
      ...
      *  - settings
          ...
          * @param searchRules.searchRulesParams - The searchRulesParams object.
                 * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
    */
    searchRules(     { indexName, searchRulesParams,  }: SearchRulesProps,
requestOptions?: RequestOptions ) : Promise<SearchRulesResponse> {
    ...
    /**
      ...
      *  - search
          ...
          * @param searchSingleIndex.searchParams - The searchParams object.
                 * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
    */
    searchSingleIndex<T>(     { indexName, searchParams,  }: SearchSingleIndexProps,
requestOptions?: RequestOptions ) : Promise<SearchResponse<T>> {
    ...
    /**
      ...
      *  - settings
          ...
          * @param searchSynonyms.searchSynonymsParams - Body of the `searchSynonyms` operation.
                 * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
    */
    searchSynonyms(     { indexName, searchSynonymsParams,  }: SearchSynonymsProps,
requestOptions?: RequestOptions ) : Promise<SearchSynonymsResponse> {
    ...
    /**
      ...
      * @deprecated
             ...
             * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
    */
    searchUserIds(       searchUserIdsParams: SearchUserIdsParams  ,
requestOptions?: RequestOptions ) : Promise<SearchUserIdsResponse> {
    ...
    /**
      ...
      *  - editSettings
             ...
             * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
    */
    setDictionarySettings(       dictionarySettingsParams: DictionarySettingsParams  ,
requestOptions?: RequestOptions ) : Promise<UpdatedAtResponse> {
    ...
    /**
      ...
      *  - editSettings
          ...
          * @param setSettings.forwardToReplicas - Whether changes are applied to replica indices.
                 * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
    */
    setSettings(     { indexName, indexSettings, forwardToReplicas,  }: SetSettingsProps,
requestOptions?: RequestOptions ) : Promise<UpdatedAtResponse> {
    ...
    /**
      ...
      *  - admin
          ...
          * @param updateApiKey.apiKey - The apiKey object.
                 * @param requestOptions - The requestOptions to send along with the query, they will be merged with the transporter requestOptions.
    */
    updateApiKey(     { key, apiKey,  }: UpdateApiKeyProps,
requestOptions?: RequestOptions ) : Promise<UpdateApiKeyResponse> {
