    ...
    def self.create(app_id, api_key, region = nil, opts = {})
      ...
      hosts <<
        Transport::StatefulHost.new(
          "personalization.{region}.flapjack.io".sub("{region}", region),
          accept: CallType::READ | CallType::WRITE
        )

      config = Flapjack::Configuration.new(app_id, api_key, hosts, "Personalization", opts)
      new(config)
    end
