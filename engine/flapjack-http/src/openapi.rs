...
#[openapi(
    ...
    paths(
        ...
        crate::handlers::migration::preview_algolia_migration,
        ...
        crate::handlers::migration::resume_algolia_migration,
        crate::handlers::migration::preview_meilisearch_migration,
        crate::handlers::migration::submit_meilisearch_migration,
        crate::handlers::migration::get_meilisearch_migration_status,
        crate::handlers::migration::cancel_meilisearch_migration,
        crate::handlers::migration::acknowledge_meilisearch_migration,
        crate::handlers::migration::resume_meilisearch_migration,
        crate::handlers::migration::preview_typesense_migration,
        crate::handlers::migration::submit_typesense_migration,
        crate::handlers::migration::get_typesense_migration_status,
        crate::handlers::migration::cancel_typesense_migration,
    ...
    components(
        schemas(
            ...
            crate::handlers::migration::MigrateFromMeilisearchRequest,
            crate::handlers::migration::MigrationPreviewResponse,
            crate::handlers::migration::MigrationPreviewSourceCounts,
            ...
            crate::handlers::migration::MigrationTopology,
            crate::handlers::migration::BulkReplaceReceipt,
